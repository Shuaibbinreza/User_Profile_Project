                                        ...
                                        <div class="modal-body">
                                            <form>
                                                {{-- <form id="educationForm"  
                                                    ...
                                                    @method('POST') --}}
                                                <div class="p-2 ">
                                                    <h6 class="fw-bolder">Add Academic Record </h6>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-check mt-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="foreignInstitute" name="foreigninstitute">
