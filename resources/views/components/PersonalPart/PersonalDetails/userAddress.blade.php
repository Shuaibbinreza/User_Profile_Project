...
data-bs-whatever="@mdo"> <i class="fa-solid fa-pen-to-square"
    style="color: #376ac3;"></i> Edit
        ...
        <!-- Modal -->
        <div class="modal fade" id="addressEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addressEditLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Thana/Upazila</label>
                                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
