<div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingLanguage">
        <button class="accordion-button collapsed fs-3 fw-semibold text-dark" type="button" data-bs-toggle="collapse"
            data-bs-target="#flush-collapseLanguage" aria-expanded="false" aria-controls="flush-collapseLanguage">
            Language Proficiency
        </button>
    </h2>
    <div id="flush-collapseLanguage" class="accordion-collapse collapse" aria-labelledby="flush-headingLanguage"
