...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
		<img alt="Logo" src="https://softexpo.com.bd/assets/media/exhibitor_logo/1662384829.png" class="h-200px app-sidebar-logo-default" />
		<img alt="Logo" src="https://media.licdn.com/dms/image/C560BAQFC2aGlg6p2vQ/company-logo_200_200/0/1641293524116/tappware_solutions_limited_logo?e=2147483647&v=beta&t=zibY_DlLzKBh8Q5bM2kpS6L2G_G3SvfdHbZKpu1y9NY" class="h-40px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
