<x-auth-layout>
    ...
    <form class="form w-100" 
        ...
        <div class="fv-row mb-8">
            ...
            <label class="btn btn-secondary fw-bold" for="male">
            ...
            <label class="btn btn-secondary" for="others">
                <i class="bi bi-gender-female"></i>
                Others
            </label>
        </div>
        ...
        <div class="fv-row mb-8">
            ...
            <select name="phone_country_code" aria-label="Select a skill" data-control="select2" data-placeholder="Select a country code.." 
                class="form-select form-select-solid form-select-lg border border-secondary">
