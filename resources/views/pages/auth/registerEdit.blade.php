    ...
    <div class="card p-10"> 
        ...
        <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="{{ route('login') }}" action="{{ route('register') }}">
            ...
            <div class="fv-row mb-8">
                ...
                <input type="radio" class="btn-check" name="gender" id="option1" autocomplete="off" checked>
                ...
                <input type="radio" class="btn-check" name="gender" id="option4" autocomplete="off">
            ...
            <div class="fv-row mb-8">
                ...
                <select name="countrycode" aria-label="Select a skill" data-control="select2" data-placeholder="Select a country code.." 
                    class="form-select form-select-solid form-select-lg border border-secondary">
            ...
            <div class="fv-row mb-8" data-kt-password-meter="true">
                ...
                <div class="mb-1">
                    ...
                    <div class="position-relative mb-3">
                        <label for="name" class="text-gray-700 fw-semibold fs-20">Password</label>
            ...
            <div class="fv-row mb-8">
                ...
                <label for="name" class="text-gray-700 fw-semibold fs-20">Confirm Password</label>
